...
define_syscall!(fn sol_set_subaccount_slice(account_info_addr: *const u8, account_info_len: u64) -> u64);
define_syscall!(fn sol_self_invoke(instruction_addr: *const u8, account_infos_addr: *const u8, account_infos_len: u64, subaccounts_seeds_addr: *const u8, subaccounts_seeds_len: u64) -> u64);
