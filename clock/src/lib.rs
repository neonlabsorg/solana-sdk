...
pub const MAX_HASH_AGE_IN_SECONDS: usize = 3600;

#[cfg(test)]
static_assertions::const_assert_eq!(MAX_RECENT_BLOCKHASHES, 144000);
...
#[cfg(test)]
static_assertions::const_assert_eq!(MAX_PROCESSING_AGE, 72000);
