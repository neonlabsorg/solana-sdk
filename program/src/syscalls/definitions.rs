...
pub use solana_define_syscall::definitions::{
    ...
    sol_get_sysvar, sol_keccak256, sol_remaining_compute_units, sol_account_data_read,
    sol_account_data_write, sol_account_lamports_get, sol_account_lamports_set, sol_load_account,
};
